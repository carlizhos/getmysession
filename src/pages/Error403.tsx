...
import { ShieldAlert, ArrowLeft, Compass, Home } from "lucide-react";
...
const Error403 = () => {
  ...
  useEffect(() => {
    console.warn("403 Error: Forbidden access attempt at:", location.pathname);
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden"
      style={{
        background: `
          radial-gradient(ellipse at 20% 50%, hsl(345 85% 57% / 0.08) 0%, transparent 50%),
          radial-gradient(ellipse at 80% 20%, hsl(355 85% 57% / 0.08) 0%, transparent 50%),
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div
          ...
          style={{
            background: 'radial-gradient(circle, hsl(345 85% 57%) 0%, transparent 70%)',
            top: '-10%',
            right: '-5%',
        ...
        <div
          ...
          style={{
            background: 'radial-gradient(circle, hsl(355 85% 57%) 0%, transparent 70%)',
            bottom: '-5%',
            left: '-5%',
      ...
      <div className="relative z-10 flex flex-col items-center px-6 max-w-2xl mx-auto text-center">
        ...
        >
          <div className="relative group flex items-center justify-center w-36 h-36">
            <div
              ...
              style={{
                background: 'linear-gradient(135deg, hsl(345 85% 57%) 0%, hsl(355 85% 57%) 100%)',
              }}
            />
            <ShieldAlert className="w-20 h-20 relative z-10 text-rose-500/80 drop-shadow-xl" />
          </div>
        </div>
        ...
        >
          <h1
            ...
            style={{
              background: 'linear-gradient(135deg, hsl(345 85% 57%) 0%, hsl(355 85% 57%) 50%, hsl(0 17% 57%) 100%)',
        ...
        >
          <p className="text-muted-foreground text-base md:text-lg max-w-md leading-relaxed">
            No tienes los permisos necesarios para ver esta página. Por seguridad, el acceso ha sido bloqueado.
          </p>
        </div>
        ...
        >
          <button
            ...
            style={{
              background: 'linear-gradient(135deg, hsl(345 85% 50%) 0%, hsl(355 85% 42%) 100%)',
            }}
          >
